...
$correo=$_POST['txtcorreoempresa']; //correo ==>correo principal del comercio
$direccion=$_POST['txtdireEmpresa']; //direccion de habitacion ==> direccion del comercio
$id_servicio=$_POST['selectbasic2']; // id del servicio (luego hacer consulta con el id)
$costoInstalacion=$_POST['costoInstalacionE']; //costo por instalacion
$notaObservacion=$_POST['txtnotaE']; //nota sobre la instalacion
$statuscontrato=$_POST['radioContratoE']; //confirmacion de contrato SI / NO / PENDIENTE
$nombreComercio=$_POST['txtnombreEmpresa']; //nombre del comercio
...
$movimiento='AGREGAR CLIENTE EMPRESARIAL'; //informacion de gestion dentro del modulo
