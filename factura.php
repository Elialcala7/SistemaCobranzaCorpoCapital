...
/*
cp.id_cliente 	  0 => 73
cs.condicion_cliente 1 => 1
cs.nombres_cliente   2 => stiven padron
cs.ci_cliente 	  3 => 2365478
cs.telefono_principal  4 => 02123612718
cs.telefono_alterno    5  => 04164785120
cs.correo    6 => prudencia@gmail.com
cs.direccion 7 => stiven padron
cp.fecha_registro 8 => 2020-04-14
cp.hora 9 => 09:20:52 AM
cp.no_fact 10 => FACT-0000-00073
cp.monto_pagado 11 => 25000
cp.monto_pendiente 12 => 0
cp.detalle_pago 13 => completo
sv.nombre_servicio 14 => PRUEBA
sv.contenido_servicio  15 => SEGURIDAD
cs.costos_instalacion  16 => 15000
us.nombre		17 => ELY
us.apellido		18 => ALCALA
fp.nombre_pago 	19 => EFECTIVO
cs.nombre_comercio 20
cs.otro_correo     21
cs.costo_servicio 22    => 10000
...
$totalPagar=($costoServicio + $costoInstalacion);
...
<table  align="center" cellspacing="3" cellpadding="1" style="border-top: 1px dotted black; border-bottom: 1px dotted black;" WIDTH=400 HEIGHT=10>
  <tr>
   ...
   <tr>
    ...
    <tr>
      <td scope="row" align="center" class="linea-2" width="10px">2</td>
      <td class="linea-2" align="center" width="10px">'.$detalleInstalacion.'</td>
      <td class="linea-2" align="center" width="10px">'.$costoInstalacion.'</td>
      <td class="linea-2" align="center" width="10px">0</td>
      <td class="linea-2" align="center" width="10px">'.$costoInstalacion.'</td>
    </tr>
    <tr>
